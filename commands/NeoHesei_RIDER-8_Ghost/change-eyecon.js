...
exports.run = (client, msg) => {
    ...
    var Rider_KEY = 121;//default key for the default belt
    var RequiredSlots = 1;
    var ReplacementText = "None";
    var SlotToUse = 1;
    var Class_Low_Range = 7999;
    var Class_High_Range = 9000;
    var ValidChangerIDs = []; 
    var TrasferableChangerIDsExceptions = []; 
    var Series_ID = 17; //ghost
    ...
    var HenshinCount = 1;
    var ItemName = "Eyecon";
    var SlotName = "Chamber";

    ValidItemKeyword.push("eyecon");

    ValidChangerIDs.push(121);//ghost driver
    ValidChangerIDs.push(122);//ghost driver G
    ValidChangerIDs.push(124);//Genma Driver
    ValidChangerIDs.push(123);//mega uloader
