...
exports.run = (client, msg) => {
        ...
        if (msg.content.startsWith("!gosie")){
        var strings = "Robo"
        knight = strings.strike() + " Gosie Kn";
        };//if
        ...
        knight = knight + "ght!";
        msg.reply(knight);
        console.log (knight + ": 'i' count is " + settings.robocount);
};//run
...
exports.conf = {
  enabled: true,
  runIn: ["text"],
  aliases: ["gosieknight", "robo knight", "gosie knight"],
  permLevel: 0,
  botPerms: [],
  requiredFuncs: []
};
