...
exports.run = (client, msg) => {
	...
	var   playername  = msg.author.username;
        ...
        const RiderEmbed = new discord.RichEmbed()
	      ...
	      RiderEmbed.setThumbnail('http://www.maskedriders.info/Mee6RP/statusPic/HurricaneRing.jpg')
              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                ...
                if ((validform >= 5000) && (validform < 6000)){
                            if (validform == 5100){//wiseman
                                    ...
                                    connection.query("UPDATE " + settings.dbtable + " SET CLASS_ID_Sub = 5240 WHERE ID = '" + playeruid + "'");
                                    ...
                                    connection.query("UPDATE " + settings.dbtable + " SET CLASS_ID_Sub = 5040 WHERE ID = '" + playeruid + "'");
                                    ...
                                    if (validform == 5000){
                                        RiderEmbed.addField('Huricane, Please', 'Fu-Fu, Fu-Fu-Fu-Fu!', true)
                                        RiderEmbed.addField('Transform', 'Transforms into Huricane Style.', true)
                                        RiderEmbed.setImage('http://www.maskedriders.info/Mee6RP/statusPic/WizardHurricaneStyle.png')
                                    } else if (validform == 5140){//beast in magic land
                                        RiderEmbed.addField('Huricane', 'Go!', true)
                                        RiderEmbed.addField('Transform', 'Transforms into Huricane Style.', true)
                                    } else { 
                                        RiderEmbed.addField('Tempest, Now!', 'Fu-Fu, Fu-Fu-Fu-Fu!', true)
                                        RiderEmbed.addField('Transform', 'Transforms into Tempest Style.', true)
