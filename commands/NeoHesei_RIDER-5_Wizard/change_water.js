...
exports.run = (client, msg) => {
	...
	var   playername  = msg.author.username;
        ...
        const RiderEmbed = new discord.RichEmbed()
	      ...
	      RiderEmbed.setThumbnail('http://www.maskedriders.info/Mee6RP/statusPic/Waterring.png')
              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                ...
                if ((validform >= 5000) && (validform < 6000)){
                            if (validform == 5100){//wiseman
                                    ...
                                    connection.query("UPDATE " + settings.dbtable + " SET CLASS_ID_Sub = 5220 WHERE ID = '" + playeruid + "'");
                                    ...
                                    connection.query("UPDATE " + settings.dbtable + " SET CLASS_ID_Sub = 5020 WHERE ID = '" + playeruid + "'");
                                    ...
                                    if (validform == 5000){
                                        RiderEmbed.addField('Water, Please', 'Sui-Sui, Sui-Sui!', true)
                                        RiderEmbed.addField('Transform', 'Transforms into Water Style.', true)
                                        RiderEmbed.setImage('http://www.maskedriders.info/Mee6RP/statusPic/WizardWaterStyle.png')
                                    } else if (validform == 5140){//beast in magic land
                                        RiderEmbed.addField('Water', 'Go!', true)
                                        RiderEmbed.addField('Transform', 'Transforms into Water Style.', true)
                                    } else { 
                                        RiderEmbed.addField('Hydro, Now!', 'Sui-Sui, Sui-Sui!', true)
                                        RiderEmbed.addField('Transform', 'Transforms into Hydro Style.', true)
