...
exports.run = (client, msg) => {
	...
	var   playername  = msg.author.username;
        ...
        const RiderEmbed = new discord.RichEmbed()
	      ...
	      RiderEmbed.setThumbnail('http://www.maskedriders.info/Mee6RP/statusPic/Flame.PNG')
              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                ...
                if ((validform >= 5000) && (validform < 6000)){
                            if (validform == 5100){//wiseman
                                    ...
                                    connection.query("UPDATE " + settings.dbtable + " SET CLASS_ID_Sub = 5210 WHERE ID = '" + playeruid + "'");
                                    ...
                                    connection.query("UPDATE " + settings.dbtable + " SET CLASS_ID_Sub = 5010 WHERE ID = '" + playeruid + "'");
                                    ...
                                    if (validform == 5000){//wizard
                                        RiderEmbed.addField('Flame, Please', 'Hi-Hi, Hi-Hi-Hi!', true)
                                        RiderEmbed.addField('Transform', 'Transforms into Flame Style.', true)
                                        RiderEmbed.setImage('http://www.maskedriders.info/Mee6RP/statusPic/WizardFlameStyle.png')
                                    } else if (validform == 5140){//beast in magic land
                                        RiderEmbed.addField('Flame', 'Go!', true)
                                        RiderEmbed.addField('Transform', 'Transforms into Flame Style.', true)
                                    } else { 
                                        RiderEmbed.addField('Volcano, Now!', 'Hi-Hi, Hi-Hi-Hi!', true)
                                        RiderEmbed.addField('Transform', 'Transforms into Volcano Style.', true)
