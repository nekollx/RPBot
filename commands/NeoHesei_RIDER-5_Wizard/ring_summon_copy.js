...
exports.run = (client, msg) => {
	...
	var   playername  = msg.author.username;
        ...
        const RiderEmbed = new discord.RichEmbed()
	      ...
	      RiderEmbed.setThumbnail('http://www.maskedriders.info/Mee6RP/statusPic/Copyring.png')
              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                      ...
                      if ((validform >= 5000) && (validform < 6000)){
                            if ((validform == 5100) || (validform == 5120) || (validform == 5110)){//wiseman, sorcerer, mage
                                    ...
                                    RiderEmbed.addField('Summon', 'Creates a copy of the user who moves independently, or a copy of active weapons.', true)
                            } else if (validform == 5000){//wizard
                                    RiderEmbed.addField('Copy', 'Please.', true)
                                    RiderEmbed.addField('Summon', 'Creates a copy of the user who moves in sync, or a copy of active weapons.', true)
                            } else if (validform == 5140){//beast in magic land
                                    RiderEmbed.addField('Copy', 'Go!', true)
                                    RiderEmbed.addField('Summon', 'Creates a copy of the user who moves in sync, or a copy of active weapons.', true)
