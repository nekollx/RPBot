...
exports.run = (client, msg) => {
	...
	var   playername  = msg.author.username;
        ...
        const RiderEmbed = new discord.RichEmbed()
	      ...
	      RiderEmbed.setThumbnail('http://www.maskedriders.info/Mee6RP/statusPic/KRWi-Falco_Ring.png')
              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                ...
                if ((validform >= 5000) && (validform < 6000)){
                            if (validform == 5100){//wiseman
                                    ...
                                    connection.query("UPDATE " + settings.dbtable + " SET CLASS_ID_Sub = 5310 WHERE ID = '" + playeruid + "'");
                                    ...
                                    if (validform == 5000){
                                        RiderEmbed.addField('Beast (Falco)', 'Please.', true)
                                        RiderEmbed.addField('Transform', 'Gain Beast Mantle (Falco)', true)
                                        RiderEmbed.setImage('http://www.maskedriders.info/Mee6RP/statusPic/Wizard_Falco.jpg')
                                    } else if ((validform == 5130) || (validform == 5140)) { 
                                        RiderEmbed.addField('Falco, Go', 'Fa-Fa-Fa-Falco!', true)
                                        RiderEmbed.addField('Summon', 'Gain the orange Falco Mantle, gives the ability to fly.', true)
                                        RiderEmbed.setImage('http://www.maskedriders.info/Mee6RP/statusPic/Beast_Falcon_Mant.png')
                                    } else { 
                                        RiderEmbed.addField('Beast (Falco)', 'Now!', true)
                                        RiderEmbed.addField('Transform', 'Gain Beast Mantle (Falco)', true)
