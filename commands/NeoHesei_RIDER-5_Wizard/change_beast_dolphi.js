...
exports.run = (client, msg) => {
	...
	var   playername  = msg.author.username;
        ...
        const RiderEmbed = new discord.RichEmbed()
	      ...
	      RiderEmbed.setThumbnail('http://www.maskedriders.info/Mee6RP/statusPic/KRWi-Dolphin_Ring.png')
              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                ...
                if ((validform >= 5000) && (validform < 6000)){
                            if (validform == 5100){//wiseman
                                    ...
                                    connection.query("UPDATE " + settings.dbtable + " SET CLASS_ID_Sub = 5330 WHERE ID = '" + playeruid + "'");
                                    ...
                                    if (validform == 5000){
                                        RiderEmbed.addField('Beast (Dolphi)', 'Please.', true)
                                        RiderEmbed.addField('Transform', 'Gain Beast Mantle (Dolphi)', true)
                                        ...
                                        RiderEmbed.addField('Dolphi, Go', 'Do-Do-Do-Do-Dolphi!', true)
                                        RiderEmbed.addField('Summon', 'Gain the purple Dolphi Mantle, gives ability to swim and purple magical healing energy.', true)
                                        RiderEmbed.setImage('http://www.maskedriders.info/Mee6RP/statusPic/Beast_Dolphi_Mant.png')
                                    } else { 
                                        RiderEmbed.addField('Beast (Dolphi)', 'Now!', true)
                                        RiderEmbed.addField('Transform', 'Gain Beast Mantle (Dolphi)', true)
