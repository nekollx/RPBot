...
exports.run = (client, msg) => {
	...
	var   playername  = msg.author.username;
        ...
        const RiderEmbed = new discord.RichEmbed()
	      ...
	      RiderEmbed.setThumbnail('http://www.maskedriders.info/Mee6RP/statusPic/Dressupketchup.PNG')
              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                      ...
                      if ((validform >= 5000) && (validform < 6000)){
                            if ((validform == 5100) || (validform == 5120) || (validform == 5110)){//wiseman, sorcerer, mage
                                    RiderEmbed.addField('Costume', 'Now!', true)
                                    RiderEmbed.addField('Transform', 'Changes the wearer\'s clothes into an outfit appropriate for the setting (i.e., a formal suit for a fancy party, a student\'s uniform to enter a school).', true)
                            } else if (validform == 5000){//wizard
                                    RiderEmbed.addField('Dress Up', 'Please.', true)
                                    RiderEmbed.addField('Transform', 'Changes the wearer\'s clothes into an outfit appropriate for the setting (i.e., a formal suit for a fancy party, a student\'s uniform to enter a school).', true)
                            } else if (validform == 5140){//beast in magic land
                                    RiderEmbed.addField('Dress Up', 'Go!', true)
                                    RiderEmbed.addField('Transform', 'Changes the wearer\'s clothes into an outfit appropriate for the setting (i.e., a formal suit for a fancy party, a student\'s uniform to enter a school).', true)
