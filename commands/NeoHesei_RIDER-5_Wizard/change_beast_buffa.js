...
exports.run = (client, msg) => {
	...
	var   playername  = msg.author.username;
        ...
        const RiderEmbed = new discord.RichEmbed()
	      ...
	      RiderEmbed.setThumbnail('http://www.maskedriders.info/Mee6RP/statusPic/Buffatring.PNG')
              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                ...
                if ((validform >= 5000) && (validform < 6000)){
                            if (validform == 5100){//wiseman
                                    ...
                                    connection.query("UPDATE " + settings.dbtable + " SET CLASS_ID_Sub = 5320 WHERE ID = '" + playeruid + "'");
                                    ...
                                    if (validform == 5000){
                                        RiderEmbed.addField('Beast (Buffa)', 'Please.', true)
                                        RiderEmbed.addField('Transform', 'Gain Beast Mantle (Buffa)', true)
                                        ...
                                        RiderEmbed.addField('Buffa, Go', 'Bu-Bu-Bububu-Buffa!', true)
                                        RiderEmbed.addField('Summon', 'Gain the red Buffa Mantle, enhances physical strength and endurance.', true)
                                        RiderEmbed.setImage('http://www.maskedriders.info/Mee6RP/statusPic/Buffa.png')
                                    } else { 
                                        RiderEmbed.addField('Beast (Buffa)', 'Now!', true)
                                        RiderEmbed.addField('Transform', 'Gain Beast Mantle (Buffa)', true)
