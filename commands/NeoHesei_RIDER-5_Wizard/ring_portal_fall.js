...
exports.run = (client, msg) => {
	...
	var   playername  = msg.author.username;
        ...
        const RiderEmbed = new discord.RichEmbed()
	      ...
	      RiderEmbed.setThumbnail('http://www.maskedriders.info/Mee6RP/statusPic/KRWi-Fall_Ring.png')
              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                      ...
                      if ((validform >= 5000) && (validform < 6000)){
                            if ((validform == 5100) || (validform == 5120) || (validform == 5110)){//wiseman, sorcerer, mage
                                    RiderEmbed.addField('Hole', 'Now!', true)
                                    RiderEmbed.addField('Portal', 'Creates a hole for wizard or anyone/anything else to fall into, the speed of the falling object can also be controled.', true)
                            } else if (validform == 5000){//wizard
                                    RiderEmbed.addField('Fall', 'Please.', true)
                                    RiderEmbed.addField('Portal', 'Creates a hole for wizard or anyone/anything else to fall into.', true)
                            } else if (validform == 5140){//beast in magic land
                                    RiderEmbed.addField('Fall', 'Go!', true)
                                    RiderEmbed.addField('Portal', 'Creates a hole for wizard or anyone/anything else to fall into.', true)
