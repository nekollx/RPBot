...
exports.run = (client, msg) => {
	...
	var   playername  = msg.author.username;
        ...
        const RiderEmbed = new discord.RichEmbed()
	      ...
	      RiderEmbed.setThumbnail('http://www.maskedriders.info/Mee6RP/statusPic/1000078657_2.jpg')
              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                ...
                if ((validform >= 5000) && (validform < 6000)){
                            if (validform == 5100){//wiseman
                                    ...
                                    connection.query("UPDATE " + settings.dbtable + " SET CLASS_ID_Sub = 5070 WHERE ID = '" + playeruid + "'");
                                    ...
                                    if (validform == 5000){
                                        RiderEmbed.addField('Special Rush, Please.', 'Flame, Water, Huricane, Land!', true)
                                        RiderEmbed.addField('Transform', 'Transforms into Special Rush Style', true)
                                        RiderEmbed.setImage('http://www.maskedriders.info/Mee6RP/statusPic/Wzalldragon.png')
                                    } else if (validform == 5140){//beast in magic land
                                        RiderEmbed.addField('Special Rush, Go!', 'Flame, Water, Huricane, Land!', true)
                                        RiderEmbed.addField('Transform', 'Transforms into Special Rush Style', true)
                                    } else { 
                                        RiderEmbed.addField('Special Rush, Now!', 'Volcano, Hydro, Tempest, Horizon!', true)
                                        RiderEmbed.addField('Transform', 'Transforms into Special Rush Style', true)
