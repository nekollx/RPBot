...
exports.run = (client, msg) => {
    ...
    var Rider_KEY = 54;//default key for the default belt
    var RequiredSlots = 1;
    var ReplacementText = "None";
    var SlotToUse = 1;
    var Class_Low_Range = 4999;
    var Class_High_Range = 6000;
    var ValidChangerIDs = []; 
    var TrasferableChangerIDsExceptions = []; 
    var Series_ID = 14; //wizard
    ...
    var HenshinCount = 1;
    var ItemName = "Ring";
    var SlotName = "Handshake";

    ValidItemKeyword.push("ring");

    ValidChangerIDs.push(104);//beast driver
    ValidChangerIDs.push(105);//beast magic land
    ValidChangerIDs.push(103);//white wizard
    ValidChangerIDs.push(54);//wizard driver

    TrasferableChangerIDsExceptions.push(104);//beast driver
