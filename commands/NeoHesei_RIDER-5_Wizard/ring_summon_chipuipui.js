...
exports.run = (client, msg) => {
	...
	var   playername  = msg.author.username;
        ...
        const RiderEmbed = new discord.RichEmbed()
	      ...
	      RiderEmbed.setThumbnail('http://www.maskedriders.info/Mee6RP/statusPic/1474423_492197744232994_388068926_n.jpg')
              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                      ...
                      if ((validform >= 5000) && (validform < 6000)){
                            if ((validform == 5100) || (validform == 5120) || (validform == 5110)){//wiseman, sorcerer, mage
                                    RiderEmbed.addField('Chichin Pui Pui', 'ERROR.', true)
                                    RiderEmbed.addField('Summon', 'Initial use provides an error on the WizarDriver, but when reacting to the Hope Ring, it allows Haruto to exit his body and enter his own Underworld as another Wizard.', true)
