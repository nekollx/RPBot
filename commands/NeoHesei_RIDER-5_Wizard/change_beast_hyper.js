...
exports.run = (client, msg) => {
	...
	var   playername  = msg.author.username;
        ...
        const RiderEmbed = new discord.RichEmbed()
	      ...
	      RiderEmbed.setThumbnail('http://www.maskedriders.info/Mee6RP/statusPic/Hypering.PNG')
              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                ...
                if ((validform >= 5000) && (validform < 6000)){
                            if (validform == 5100){//wiseman
                                    ...
                                    connection.query("UPDATE " + settings.dbtable + " SET CLASS_ID_Sub = 5350 WHERE ID = '" + playeruid + "'");
                                    ...
                                    if (validform == 5000){
                                        RiderEmbed.addField('Beast (Hyper)', 'Please.', true)
                                        ...
                                        RiderEmbed.addField('Hyper, Go', 'Hy-Hy-Hy-Hyper!', true)
                                        RiderEmbed.addField('Transform', 'Transform into an ancient wizard (Hyper).', true)
                                        RiderEmbed.setImage('http://www.maskedriders.info/Mee6RP/statusPic/KRWi-Kamen_Rider_Beast_Hyper.png')
                                    } else { 
                                        RiderEmbed.addField('Beast (Hyper)', 'Now!', true)
                                        RiderEmbed.addField('Transform', 'Transform into a weaker incompatable Style.', true)
