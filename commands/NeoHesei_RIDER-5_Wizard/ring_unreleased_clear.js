              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                      ...
                      if ((validform >= 5000) && (validform < 6000)){
                            if ((validform == 5100) || (validform == 5120) || (validform == 5110)){//wiseman, sorcerer, mage
                                    RiderEmbed.addField('Invisible', 'Now!', true)
				    RiderEmbed.addField('Transform', 'Makes the users completly transparent, and allows travel to Ryuki\'s Mirror World.', true)//small, big, extend, liquid, dress up, excite, clear, special rush, beast mantles, hyper beast
                            } else if (validform == 5140){//beast in magic land
                                    RiderEmbed.addField('Clear', 'Go!', true)
				    RiderEmbed.addField('Transform', 'Makes the users completly transparent, and allows travel to Ryuki\'s Mirror World.', true)//small, big, extend, liquid, dress up, excite, clear, special rush, beast mantles, hyper beast
                            } else if (validform == 5000){//wizard
                                    RiderEmbed.addField('Clear', 'Please.', true)
				    RiderEmbed.addField('Transform', 'Makes the users completly transparent, and allows travel to Ryuki\'s Mirror World.', true)//small, big, extend, liquid, dress up, excite, clear, special rush, beast mantles, hyper beast
