...
exports.run = (client, msg) => {
	...
	var   playername  = msg.author.username;
        ...
        const RiderEmbed = new discord.RichEmbed()
	      ...
	      RiderEmbed.setThumbnail('http://www.maskedriders.info/Mee6RP/statusPic/Beast_ChimaeRise_Ring.png')
              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                      ...
                      if ((validform >= 5000) && (validform < 6000)){
                            if ((validform == 5100) || (validform == 5120) || (validform == 5110)){//wiseman, sorcerer, mage
                                    RiderEmbed.addField('Chimarise', 'Now!', true)
                                    RiderEmbed.addField('Summon', 'Chimera (in the Underworld).', true)
                            } else if (validform == 5000){//wizard
                                    RiderEmbed.addField('Chimarise', 'Please.', true)
                                    RiderEmbed.addField('Summon', 'Chimera (in the Underworld).', true)
                            } else if ((validform == 5140) || (validform == 5130)){//beast in magic land, regular beast
                                    RiderEmbed.addField('Chimarise', 'Go!', true)
                                    RiderEmbed.addField('Summon', 'Chimera (in the Underworld).', true)
                            }//if else
