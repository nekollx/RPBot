              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                      ...
                      if ((validform >= 5000) && (validform < 6000)){
                            if ((validform == 5100) || (validform == 5120) || (validform == 5110)){//wiseman, sorcerer, mage
                                    RiderEmbed.addField('Psychic', 'Now!', true)
				    RiderEmbed.addField('Special', 'Move things with your mind, and read minds.', true)//please, common omni effect rings, christmas, hope, dance, eclipse, create wizard, congradulations
                            } else if (validform == 5140){//beast in magic land
                                    RiderEmbed.addField('Psychokinesis', 'Go!', true)
				    RiderEmbed.addField('Special', 'Move things with your mind, and read minds.', true)//please, common omni effect rings, christmas, hope, dance, eclipse, create wizard, congradulations
                            } else if (validform == 5000){//wizard
                                    RiderEmbed.addField('Psychokinesis', 'Please.', true)
				    RiderEmbed.addField('Special', 'Move things with your mind, and read minds.', true)//please, common omni effect rings, christmas, hope, dance, eclipse, create wizard, congradulations
