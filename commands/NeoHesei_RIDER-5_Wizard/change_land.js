...
exports.run = (client, msg) => {
	...
	var   playername  = msg.author.username;
        ...
        const RiderEmbed = new discord.RichEmbed()
	      ...
	      RiderEmbed.setThumbnail('http://www.maskedriders.info/Mee6RP/statusPic/LandRing.jpg')
              ...
              RiderEmbed.setFooter('Data Card ~' + settings.PlayerClassName(validform), settings.serverpic)
                ...
                if ((validform >= 5000) && (validform < 6000)){
                            if (validform == 5100){//wiseman
                                    ...
                                    connection.query("UPDATE " + settings.dbtable + " SET CLASS_ID_Sub = 5230 WHERE ID = '" + playeruid + "'");
                                    ...
                                    connection.query("UPDATE " + settings.dbtable + " SET CLASS_ID_Sub = 5030 WHERE ID = '" + playeruid + "'");
                                    ...
                                    if (validform == 5000){
                                        RiderEmbed.addField('Land, Please', 'Dododo Dododon, Don Dododon!', true)
                                        RiderEmbed.addField('Transform', 'Transforms into Land Style.', true)
                                        RiderEmbed.setImage('http://www.maskedriders.info/Mee6RP/statusPic/WizardLandStyle.png')
                                    } else if (validform == 5140){//beast in magic land
                                        RiderEmbed.addField('Land', 'Go!', true)
                                        RiderEmbed.addField('Transform', 'Transforms into Land Style.', true)
                                    } else { 
                                        RiderEmbed.addField('Horizon, Now!', 'Dododo Dododon, Don Dododon!', true)
                                        RiderEmbed.addField('Transform', 'Transforms into Horizon Style.', true)
