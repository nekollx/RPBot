            ...
            if (errU) console.log(errU);
                if (resultU.length > 0){
                    var UpdateString  = "UPDATE " + settings.playerforms+" ";
                        UpdateString += "SET ";
                        UpdateString += "Class_ID_Sub4 = " + ClassID +", ";
                        UpdateString += "Class_ID_Sub4_Name = '" + settings.PlayerClassName(ClassNameID, "yes") +"' ";
                    ...
                    if ((settings.User_Forms.get(resultU[0].Table_ID).User_ID == mentionedid) && 
                        ...
                        {settings.User_Forms.get(resultU[0].Table_ID).Class_ID_Sub4 = ClassID;}
